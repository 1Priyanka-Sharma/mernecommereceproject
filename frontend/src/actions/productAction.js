...
export const getProduct =
  ...
  async (dispatch) => {
    try {
      ...
      if (category) {
        link = `/?keyword=${keyword}&page=${currentPage}&price[gte]=${price[0]}&price[lte]=${price[25000]}&category=${category}&ratings[gte]=${ratings}`;
      }
...
console.log(res.data.resultPerPage);
console.log(res.data.filteredProductsCount);
      dispatch({
